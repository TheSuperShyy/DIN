export const content = {
  ...
  about: {
    ...
    lead: 'הסיפור של חברת "טל שולמרק בע"מ" לא התחיל במשרדים מפוארים או בתוכניות עסקיות, אלא הרבה שנים קודם לכן – כילד שהוקסם מעולם החרקים, מהתנהגות בעלי החיים ומהאיזון העדין של הטבע. אותה תשוקה לא נעלמה עם השנים; היא הפכה למנוע הצמיחה של חברה שחורטת על דגלה מקצוענות ללא פשרות.',
    sections: [
      {
        title: 'מהילד עם זכוכית המגדלת – לחברה המובילה בישראל',
        paragraphs: [
          'הקמתי את "טל שולמרק בע"מ" מתוך חזון אחד ברור: להביא את עולם ההדברה וניהול המטרדים לרמה של אמנות ומדע. לא עוד פתרונות זמניים, אלא הבנה עמוקה של שורש הבעיה, תוך כבוד לסביבה ובהתאמה לסטנדרטים הסטטוטוריים המחמירים ביותר.',
          'המסע המקצועי שלי החל עוד משנות ה-90, אז הוסמכתי לראשונה כמדביר. מאז ועד היום, עם למעלה משלושה עשורי ניסיון בשטח, אני מחזיק ברישיון מדביר מטעם המשרד להגנת הסביבה מספר רישיון: 1139. הוותק ארוך השנים הזה הוא לא רק מספר – הוא היכולת לזהות דפוסי התנהגות של מזיקים שדורשים "עין חדה" וניסיון מצטבר שאי אפשר ללמוד רק מספרים ומצגות.',
      ...
      },
      {
        ...
        paragraphs: [
          'ב"טל שולמרק בע"מ", אנחנו לא רק מרחיקים מזיקים – אנחנו מחזירים לכם את תחושת הביטחון במרחב האישי והעסקי שלכם. הניסיון שצברנו על מגוון רחב של לקוחות יחד עם הציוד המתקדם וההון האנושי המעולה שלנו, מאפשרים לנו להגיד בביטחון: אנחנו כאן כדי לפתור לכם את הבעיה, מהשורש.'
        ]
      }
    ],
    ...
    sections: [
      {
        ...
        body: 'השילוב בין הבנת התנהגות בעלי הכנף לבין הנדסה מתקדמת הוביל אותנו לפיתוח מערך מלכודות ייחודי ובלעדי לחברה. המלכודות שלנו מתוכננות ליעילות מקסימלית, בקיצור זמני העבודה והשגת תוצאות מוכחות גם באתרים מאתגרים: מפעלים, מוסדות, מחסנים לוגיסטיים, שטחים פתוחים ועוד רבים...\n\nתפקיד המערכות הוא ליצור מצב של טורף נטרף.'
      },
      {
        number: '02',

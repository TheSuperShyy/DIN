    ...
    sections: [
      {
        ...
        paragraphs: [
          'הקמתי את "טל שולמרק בע"מ" מתוך חזון אחד ברור: להביא את עולם ההדברה וניהול המטרדים לרמה של אומנות ומדע. לא עוד פתרונות זמניים, אלא הבנה עמוקה של שורש הבעיה, תוך כבוד לסביבה ובהתאמה לחוקי המדינה.',

  ...
  company: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'לכל לקוח ולכל מטרד יש פתרון ייחודי. אנו מציגים ללקוח את שיטת הטיפול הנבחרת (הדברה ירוקה, הרחקת בעלי כנף, פתרונות טכנולוגיים) בהתאם לרשויות החוק ולתקני ה-ISO.'
      },
      {
        number: '04',
        title: 'ביצוע מקצועי ובטוח',
        description: 'שלב היישום. המדבירים המורשים שלנו מבצעים את העבודה תוך שימוש בציוד מתקדם ובחומרים המאושרים על ידי המשרד להגנת הסביבה, תוך שמירה מקסימלית על בטיחות האנשים.'
      },
      {
        number: '05',
        title: 'סיכום פעילות',
        description: 'אנחנו לא נעלמים. בסיום העבודה אנו מוודאים את אפקטיביות הטיפול, מספקים דוח עבודה ממוחשב ומפורט על ידי מערכת הבקרה הייחודית שלנו.'
      }
    ],
    cells: [
